...
const timeLimit = parseInt(process.env.TIMELIMIT) || 1000 * 60;
const maxRequest = parseInt(process.env.REQUESTLIMIT) || 5;
var limiter = new RateLimiter(maxRequest, timeLimit);
